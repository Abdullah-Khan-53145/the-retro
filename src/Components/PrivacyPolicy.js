...
function PrivacyPolicy({ status }) {
  ...
  return (
    <div className="privacy__policy__main">
      <div className="privacy__policy__child">
        <div className="page_image_main">
          <div className="page_image_child">
            <img loading="lazy" src="./imgs/privay-policy.png" alt="" />
          </div>
        </div>
